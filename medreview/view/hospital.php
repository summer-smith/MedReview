        ...
        <div class="main">
            ...
            <div class="maincontent">
                ...
                <form action="." method="post">
                    <button type="submit" class="menu" name="action" value="hospitalreview">Review</button> <br><br>
                    <button type="submit" class="menu" name="action" value="searchhospitals">Search</button>                    
                </form>
            </div>
        </div>
    </body>
