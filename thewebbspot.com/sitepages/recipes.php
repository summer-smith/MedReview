...
<html lang="en-us" class="recipes">
    <head>
        ...
        <title>RECIPES | thewebbspot.com</title>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'].'/modules/header.php'; ?>
        ...
        <div class="headers">
            <h1 class="mainheaders">RECIPES</h1>
        </div> 

        <div class="pagenav">
            <ul class="pagenavlist">
                <li><a href="/sitepages/recipesbreakfast.php">BREAKFAST</a></li>
                <li><a href="/sitepages/recipeslunch.php">LUNCH</a></li>
                <li><a href="/sitepages/recipesdinner.php">DINNER</a></li>
            </ul>
        </div>
